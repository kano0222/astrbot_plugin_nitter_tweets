...
<p align="center">
  <a href="https://github.com/shitianyaa/astrbot_plugin_nitter_tweets/releases"><img alt="Version" src="https://img.shields.io/badge/version-1.6.2-blue?style=for-the-badge" /></a>
...
| `fetch_backend` | 推文抓取后端策略：`mix`（优先 FxTwitter，故障增量回退自建 Nitter，默认）、`nitter`（纯自建 Nitter）、`fx`（纯 FxTwitter；List 仍锁定 Nitter） |
